      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            <img src={`${import.meta.env.BASE_URL}manus-storage/acme-badge-logo_8e92c66b.png`}" alt="Acme Automotive" className="h-24 w-24 rounded-xl object-cover" />
        ...
        <Sidebar collapsible="icon" className="border-r-0" disableTransition={isResizing}>
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              >
                <img src={`${import.meta.env.BASE_URL}manus-storage/acme-badge-logo_8e92c66b.png`}" alt="Acme" className="h-9 w-9 rounded-lg object-cover" />
              </button>
              {!isCollapsed && (
